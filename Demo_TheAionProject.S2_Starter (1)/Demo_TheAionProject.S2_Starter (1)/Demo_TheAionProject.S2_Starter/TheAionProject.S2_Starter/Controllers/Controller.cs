...
namespace TheAionProject
{
    ...
    public class Controller
    {
        ...
        private void InitializeGame()
        {
            ...
            _gameUnivers = new Universe();
            _gameConsoleView = new ConsoleView(_gameTraveler,_gameUnivers);
            _playingGame = true;
        ...
        private void ManageGameLoop()
        {
            ...
            //
            _currentLocation = _gameUnivers.GetSpaceTimeLocationById(_gameTraveler.SpaceTimeLocationID);
            _gameConsoleView.DisplayGamePlayScreen("Current Location", Text.CurrrentLocationInfo(_currentLocation), ActionMenu.MainMenu, "");
            ...
            while (_playingGame)
            {
                ...
                switch (travelerActionChoice)
                {
                    ...
                    case TravelerAction.Travel:
                        //
                        // get new location choice and update teh current location property
                        //
        ...
        private void UpdateGameStatus()
        {
            ...
            {
                //
                //add new location to the list of visted locations if this is a first visisted
                //
