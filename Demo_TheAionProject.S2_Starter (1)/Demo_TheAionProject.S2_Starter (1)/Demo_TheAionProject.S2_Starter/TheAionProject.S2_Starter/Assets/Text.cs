...
namespace TheAionProject
{
    ...
    public static class Text
    {
        ...
        public static string CurrrentLocationInfo(SpaceTimeLocation spaceTimeLocation)
        {
            string messageBoxText =
        ...
        public static string Travel(Traveler gametravler, List<SpaceTimeLocation> spaceTimeLocations)
        {
            string messageBoxText =
                $"{gametravler.Name}, Aion Base will need to know the name of the new location.\n" +
            ...
            foreach (SpaceTimeLocation spaceTimeLocation in spaceTimeLocations)
            {
                if (spaceTimeLocation.SpaceTimeLocationID != gametravler.SpaceTimeLocationID)
                {
                    spaceTimeLocationList +=
                        $"{spaceTimeLocation.SpaceTimeLocationID}".PadRight(10) +
                        $"{spaceTimeLocation.CommonName}".PadRight(30) +
