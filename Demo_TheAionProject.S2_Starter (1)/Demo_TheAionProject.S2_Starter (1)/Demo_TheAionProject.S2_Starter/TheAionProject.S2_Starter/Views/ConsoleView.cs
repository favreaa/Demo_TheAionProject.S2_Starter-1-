...
namespace TheAionProject
{
    ...
    public class ConsoleView
    {
        ...
        public TravelerAction GetActionMenuChoice(Menu menu)
        {
            ...
            //
            // Validate key pressed as in MenuChoices ditionary
            //
        ...
        {
            DisplayGamePlayScreen("List: Space-Time Locations", Text.ListSpaceTimeLocations
            (_gameUniverse.SpaceTimeLocations), ActionMenu.MainMenu, "");
        }
        ...
        public int DisplayGetNextSpaceTimeLocation()
        {
            ...
            while (!validSpaceTimeLocationId)
            {
                ...
                if (_gameUniverse.IsValidSpaceTimeLocationId(spaceTimeLocationId))
                {
                    ...
                    {
                        ClearInputBox();
                        DisplayInputErrorMessage("It appears your attempting to travel to an inaccessible location. Please Try again.");
                    }
                ...
                {
                    DisplayInputErrorMessage("it appears you entered an invalid space_time location id. Please try again.");
                }
